...
Caja::Caja() : name("No name"), inicio(NULL), final(NULL), nodo(NULL) {}

bool Caja::isEmpty() { return inicio != NULL; }
...
void menu() {
  ...
  do {
    ...
    case 4:
      ...
      // std::cout << "Se están movimiendo los clientes a la fila D10" <<
      // std::endl;
      D10 = C20 + C25;
      bloqueo = true;
      break;
